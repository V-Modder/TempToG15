...
typedef int (*EMyDetectDevice)(HWND APPhwnd);
typedef void  (*EMyCloseDevice)(void);
typedef void (*EMySetCurrentDev)(int nCurDev);
typedef bool (*EMyInitConfig)(bool t);
typedef double (*EMyReadTemp)(bool add);
...
public:
	...
	EMyDetectDevice	_EMyDetectDevice;
	EMyCloseDevice	_EMyCloseDevice;
	EMySetCurrentDev     	_EMySetCurrentDev;
	EMyReadTemp _EMyReadTemp;
	EMyInitConfig _EMyInitConfig;
